...
public class NordwindTool extends JFrame {
  ...
  private JMenuItem item_create = new JMenuItem("Datens�tze anlegen", create);
  private JMenuItem item_edit = new JMenuItem("Datens�tze editieren", edit);
  ...
  //F�r menu_info  
  private JMenuItem item_about = new JMenuItem("�ber 'Nordwind - Tool'", info);
  ...
  public NordwindTool() { 
    ...
    textfield_empfaenger.setToolTipText("Empf�nger angeben");
